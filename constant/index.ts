...
export const applicationImages = [
  { alt: "Electric Vehicles & Battery Testing", imgUrl: "/Electric_Vehicles_&_Battery_Testing.svg", name:"Engine Testing"},
  { alt: "Engine Testing", imgUrl: "/Engine_Testing.svg", name:"Engine Testing"},
  { alt: "Aero Engine Testing", imgUrl: "/Aero_Engine_Testing.png", name:"Engine Testing"},
  { alt: "Aerospace Structural Testing", imgUrl: "/Aerospace_Structural_Testing.png", name:"Engine Testing"},
  { alt: "Wind Turbine Testing", imgUrl: "/Wind_Turbine_Testing.png", name:"Engine Testing"},
  ...
  { alt: "Oil_and_Gas", imgUrl: "/Oil_and_Gas.svg", name:"Engine Testing"},
  { alt: "Defenseg", imgUrl: "/Defense.png", name:"Engine Testing"},
  { alt: "Railway", imgUrl: "/Railway.png", name:"Engine Testing"},
  { alt: "Pharmaceutical", imgUrl: "/Pharmaceutical.png", name:"Engine Testing"},
  { alt: "Fusion Reactors", imgUrl: "/Fusion_Reactors.png", name:"Engine Testing"},
];
